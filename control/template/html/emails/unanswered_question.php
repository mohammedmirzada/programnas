...
<div style="background: #fff;color: #555;border-radius: 0px 0px 6px 6px;box-shadow: -2px 4px 7px 5px #0000000d;border: 1px solid #dddddda3;">
  <div style="padding-bottom: 4px;">
      <div style="border-radius: 0px 0px 20px 20px;margin: 0 auto;max-width: 800px;">
        ...
        <h3 style="margin-top: 18px;color: #555;margin-bottom: 8px;">Hi '.$name.', </h3>
        <div style="color: #555;margin-bottom: 12px;">Here are some unanswered questions in Programnas and you may want to answer them.</div>
        <div style="font-size: 18px;color: #000000b0;border: 1px solid #0019462e;background: #031b480a;border-radius: 6px;padding: 8px 14px 8px 12px;">
          '.$html.'
        </div>
        <div style="color: #555;font-weight: bold;margin-top: 20px;margin-bottom: 8px;">If you want to unsubscribe emails form Programnas, follow these instructions:</div>
        <div style="white-space: pre-line;line-height: 32px;border-radius: 6px;border: 1px solid #ddd;color: #555;padding: 8px 16px 8px 16px;">- Login to your account.
          - Go to Settings->Profile.
        - in the below, you can uncheck the subscription fields.</div>
